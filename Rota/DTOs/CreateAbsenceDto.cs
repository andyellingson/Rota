namespace Rota.DTOs
{
    ...
    public record CreateAbsenceDto(string StartDate, int DayCount, string Title, string? Notes, string? Color, string? AssignedToUserId = null, string? StartTime = null, string? EndTime = null);
}
